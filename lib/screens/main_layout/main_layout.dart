...
return Scaffold(
  ...
  BottomNavigationBarItem(icon: Icon(tappedindex==1?Icons.favorite:Icons.favorite_border),label: "Favorite"),
  BottomNavigationBarItem(icon: Icon(tappedindex==2?Icons.person:Icons.person_outline),label: "profile"),
